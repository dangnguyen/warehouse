 ...
 implements java_code.Warehouse.WHMOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("sayHello", new java.lang.Integer (24));
    _methods.put ("shutdown", new java.lang.Integer (25));
  }
  ...
  //Xuat kho
       ...
       case 24:  // Warehouse/WHM/sayHello
       {
         String $result = null;
       ...
       case 25:  // Warehouse/WHM/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
