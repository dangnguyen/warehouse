 ...
 implements java_code.Warehouse.WHMOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("sayHello", new java.lang.Integer (19));
    _methods.put ("shutdown", new java.lang.Integer (20));
  }
  ...
  //Xuat kho
       ...
       case 19:  // Warehouse/WHM/sayHello
       {
         String $result = null;
       ...
       case 20:  // Warehouse/WHM/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
