 ...
 implements java_code.Warehouse.WHMOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getUserListByWarehouseId", new java.lang.Integer (17));
    _methods.put ("getWarehouseListByUserId", new java.lang.Integer (18));
    _methods.put ("getUserList", new java.lang.Integer (19));
    _methods.put ("getRoleList", new java.lang.Integer (20));
    _methods.put ("getUser", new java.lang.Integer (21));
    _methods.put ("getWarehouseList", new java.lang.Integer (22));
    _methods.put ("updateWarehousePermissionForUser", new java.lang.Integer (23));
    _methods.put ("getItemImportExportInfoByTime", new java.lang.Integer (24));
    _methods.put ("sayHello", new java.lang.Integer (25));
    _methods.put ("shutdown", new java.lang.Integer (26));
  }
  ...
  //Xuat kho
       ...
       case 13:  // Warehouse/WHM/getItemType
       {
         ...
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.ItemType $result = null;
         $result = this.getItemType (warehouse_id, item_type_id, token, apiMessageList);
         out = $rh.createReply();
       ...
       case 17:  // Warehouse/WHM/getUserListByWarehouseId
       {
         short warehouse_id = in.read_short ();
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.User $result[] = null;
         $result = this.getUserListByWarehouseId (warehouse_id, token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.UserListHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       }

       case 18:  // Warehouse/WHM/getWarehouseListByUserId
       {
         short user_id = in.read_short ();
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.WarehouseInfo $result[] = null;
         $result = this.getWarehouseListByUserId (user_id, token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.WarehouseListHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       }

       case 19:  // Warehouse/WHM/getUserList
       {
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.User $result[] = null;
         $result = this.getUserList (token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.UserListHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       ...
       case 20:  // Warehouse/WHM/getRoleList
       {
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.Role $result[] = null;
         $result = this.getRoleList (token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.RoleListHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       }

       case 21:  // Warehouse/WHM/getUser
       {
         short user_id = in.read_short ();
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.User $result = null;
         $result = this.getUser (user_id, token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.UserHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       ...
       case 22:  // Warehouse/WHM/getWarehouseList
       {
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.WarehouseInfo $result[] = null;
         $result = this.getWarehouseList (token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.WarehouseListHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       ...
       case 23:  // Warehouse/WHM/updateWarehousePermissionForUser
       {
         short user_id = in.read_short ();
         short warehouse_ids[] = java_code.Warehouse.WarehouseIdListHelper.read (in);
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         this.updateWarehousePermissionForUser (user_id, warehouse_ids, token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       }

       case 24:  // Warehouse/WHM/getItemImportExportInfoByTime
       {
         short warehouse_id = in.read_short ();
         short itemCode = in.read_short ();
         long date = in.read_ulonglong ();
         String token = in.read_string ();
         java_code.Warehouse.APIMessageListHolder apiMessageList = new java_code.Warehouse.APIMessageListHolder ();
         java_code.Warehouse.Item $result = null;
         $result = this.getItemImportExportInfoByTime (warehouse_id, itemCode, date, token, apiMessageList);
         out = $rh.createReply();
         java_code.Warehouse.ItemHelper.write (out, $result);
         java_code.Warehouse.APIMessageListHelper.write (out, apiMessageList.value);
         break;
       ...
       case 25:  // Warehouse/WHM/sayHello
       {
         String $result = null;
       ...
       case 26:  // Warehouse/WHM/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
