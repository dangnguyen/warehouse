 ...
 implements java_code.Warehouse.WHMOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("sayHello", new java.lang.Integer (22));
    _methods.put ("shutdown", new java.lang.Integer (23));
  }
  ...
  //Xuat kho
       ...
       case 22:  // Warehouse/WHM/sayHello
       {
         String $result = null;
       ...
       case 23:  // Warehouse/WHM/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
