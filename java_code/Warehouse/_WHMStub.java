...
public class _WHMStub extends org.omg.CORBA.portable.ObjectImpl implements java_code.Warehouse.WHM
{
  ...
  public java_code.Warehouse.User[] getUserList (String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            ...
            try {
                ...
                return getUserList (token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // getUserList

  public java_code.Warehouse.Role[] getRoleList (String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRoleList", true);
                $out.write_string (token);
                $in = _invoke ($out);
                java_code.Warehouse.Role $result[] = java_code.Warehouse.RoleListHelper.read ($in);
                apiMessageList.value = java_code.Warehouse.APIMessageListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                return getRoleList (token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // getRoleList

  public java_code.Warehouse.User getUser (short user_id, String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return getUser (user_id, token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // getUser

  public java_code.Warehouse.WarehouseInfo[] getWarehouseList (String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getWarehouseList", true);
                $out.write_string (token);
                $in = _invoke ($out);
                java_code.Warehouse.WarehouseInfo $result[] = java_code.Warehouse.WarehouseListHelper.read ($in);
                apiMessageList.value = java_code.Warehouse.APIMessageListHelper.read ($in);
                ...
                return getWarehouseList (token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // getWarehouseList

  public void updateWarehousePermissionForUser (short user_id, short[] warehouse_ids, String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updateWarehousePermissionForUser", true);
                $out.write_short (user_id);
                java_code.Warehouse.WarehouseIdListHelper.write ($out, warehouse_ids);
                $out.write_string (token);
                $in = _invoke ($out);
                apiMessageList.value = java_code.Warehouse.APIMessageListHelper.read ($in);
                return;
                ...
                updateWarehousePermissionForUser (user_id, warehouse_ids, token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // updateWarehousePermissionForUser
  ...
  public java_code.Warehouse.Item getItemImportExportInfoByTime (short warehouse_id, short itemCode, long date, String token, java_code.Warehouse.APIMessageListHolder apiMessageList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getItemImportExportInfoByTime", true);
                $out.write_short (warehouse_id);
                $out.write_short (itemCode);
                $out.write_ulonglong (date);
                $out.write_string (token);
                $in = _invoke ($out);
                java_code.Warehouse.Item $result = java_code.Warehouse.ItemHelper.read ($in);
                apiMessageList.value = java_code.Warehouse.APIMessageListHelper.read ($in);
                ...
                return getItemImportExportInfoByTime (warehouse_id, itemCode, date, token, apiMessageList        );
            } finally {
                _releaseReply ($in);
            }
  } // getItemImportExportInfoByTime
