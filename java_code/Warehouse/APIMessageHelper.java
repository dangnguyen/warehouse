...
/**
* java_code/Warehouse/APIMessageHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Hello.idl
* 17:18:41 ICT Ch? nh?t, ngày 07 tháng tý nãm 2013
*/

abstract public class APIMessageHelper
{
  private static String  _id = "IDL:Warehouse/APIMessage/APIMessage:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (java_code.Warehouse.APIMessageHelper.id (), "APIMessage", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    java_code.Warehouse.APIMessage value = new java_code.Warehouse.APIMessage ();
    value.code = istream.read_short ();
  ...
  {
    ostream.write_short (value.code);
