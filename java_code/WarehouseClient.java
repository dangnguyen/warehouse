...
public class WarehouseClient {
  ...
  public java_code.Warehouse.Item getItemImportExportInfoByTime (short warehouse_id, short itemCode, long date, String token, java_code.Warehouse.APIMessageListHolder apiMessageList) {
  	java_code.Warehouse.Item result = null;
		try{
			String[] params = new String[4];
			params[0] = "-ORBInitialPort";
			...
			result = warehouseImpl.getItemImportExportInfoByTime(warehouse_id, itemCode, date, token, apiMessageList);
